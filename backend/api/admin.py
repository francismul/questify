...
from .models import (
    User, Course, Chapter, Quiz, Question,
    CourseRating, StudentProgress, QuizAttempt
)
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'first_name', 'last_name', 'role', 'level', 'total_xp', 'is_active', 'is_staff')
    list_filter = ('role', 'is_active', 'is_staff', 'is_superuser', 'level', 'created_at')
    ...
    readonly_fields = ('created_at', 'updated_at', 'total_xp', 'level', 'streak_days')


@admin.register(Course)
class CourseAdmin(admin.ModelAdmin):
    list_display = ('title', 'teacher', 'difficulty', 'estimated_hours', 'enrollment_count', 'created_at')
    ...
    ordering = ('-created_at',)
    readonly_fields = ('created_at', 'updated_at', 'enrollment_count', 'average_rating')
...
class ChapterAdmin(admin.ModelAdmin):
    list_display = ('title', 'course', 'order', 'estimated_minutes', 'created_at')
...
class QuizAdmin(admin.ModelAdmin):
    list_display = ('title', 'course', 'type', 'passing_score', 'max_attempts', 'time_limit', 'created_at')
...
class QuestionAdmin(admin.ModelAdmin):
    list_display = ('question', 'quiz', 'type', 'points', 'order', 'created_at')
...
class CourseRatingAdmin(admin.ModelAdmin):
    ...
    search_fields = ('course__title', 'student__email', 'student__first_name', 'student__last_name', 'review')
    ordering = ('-created_at',)
    readonly_fields = ('created_at',)
...
class StudentProgressAdmin(admin.ModelAdmin):
    list_display = ('student', 'course', 'progress_percentage', 'completed', 'enrolled_at', 'last_accessed_at')
    ...
    readonly_fields = ('enrolled_at', 'last_accessed_at', 'progress_percentage')

    fieldsets = (
        ('Progress Information', {
            'fields': ('student', 'course', 'enrolled_at', 'last_accessed_at')
        }),
        ('Completion Status', {
            'fields': ('completed', 'completed_at', 'certificate_url')
        }),
        ('Scores & Progress', {
            'fields': ('completed_chapters', 'chapter_scores', 'quiz_scores', 'final_exam_score', 'final_exam_attempts', 'total_time_spent'),
            'classes': ('collapse',)
        }),
    )
...
class QuizAttemptAdmin(admin.ModelAdmin):
    list_display = ('student', 'quiz', 'score', 'time_taken', 'started_at', 'completed_at')
