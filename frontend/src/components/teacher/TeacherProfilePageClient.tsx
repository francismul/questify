...
import { User, Camera, Save, X, BookOpen, Users, Award, TrendingUp, Calendar } from "lucide-react";
          ...
          <div className="bg-card rounded-lg p-6 shadow-sm">
            <div className="text-center">
              ...
              <div className="relative mb-4">
                <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-4 border-accent/20">
          ...
          <div className="bg-card rounded-lg p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-center gap-3 p-4 bg-accent/5 rounded-lg">
                ...
                <div>
                  <div className="text-2xl font-bold text-accent">5.0/5</div>
