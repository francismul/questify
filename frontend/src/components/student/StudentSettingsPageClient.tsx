...
export function StudentSettingsPageClient({ initialUser }: StudentSettingsPageClientProps) {
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="border-b border-border pb-4">
        ...
        <p className="text-muted-foreground mt-2">
          Manage your student account preferences and learning settings.
        </p>
      </div>
                  ...
                  <div key={key} className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        {key === "studentMessages" && "Receive messages from other students"}
                        {key === "systemAnnouncements" && "Important system announcements and updates"}
                        {key === "weeklyReports" && "Weekly summary reports of your progress"}
                      </p>
                    </div>
                    ...
                    <DropdownMenuTrigger asChild>
                      <Button variant="outline" className="w-full justify-between">
                        {settings.privacy.profileVisibility === "public" ? "Public" :
                         settings.privacy.profileVisibility === "enrolled" ? "Enrolled Students Only" : "Private"}
                  ...
                  <div key={key} className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        {key === "allowStudentMessages" && "Allow other students to send you messages"}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button variant="outline" className="w-full justify-between">
                        {settings.learning.difficulty === "beginner" ? "Beginner" :
                         settings.learning.difficulty === "intermediate" ? "Intermediate" :
                         settings.learning.difficulty === "advanced" ? "Advanced" : "Adaptive"}
                        <ChevronDown className="w-4 h-4" />
                      </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent className="w-full">
                      <DropdownMenuItem onClick={() => handleSettingChange("learning", "difficulty", "beginner")}>
                        Beginner
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => handleSettingChange("learning", "difficulty", "intermediate")}>
                        Intermediate
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => handleSettingChange("learning", "difficulty", "advanced")}>
                        Advanced
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => handleSettingChange("learning", "difficulty", "adaptive")}>
                        Adaptive
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                ...
                <div>
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button variant="outline" className="w-full justify-between">
                        {settings.learning.preferredStudyTime === "morning" ? "Morning" :
                         settings.learning.preferredStudyTime === "afternoon" ? "Afternoon" :
                         settings.learning.preferredStudyTime === "evening" ? "Evening" : "Anytime"}
                        <ChevronDown className="w-4 h-4" />
                      </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent className="w-full">
                      <DropdownMenuItem onClick={() => handleSettingChange("learning", "preferredStudyTime", "morning")}>
                        Morning
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => handleSettingChange("learning", "preferredStudyTime", "afternoon")}>
                        Afternoon
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => handleSettingChange("learning", "preferredStudyTime", "evening")}>
                        Evening
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => handleSettingChange("learning", "preferredStudyTime", "anytime")}>
                        Anytime
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange("learning", "dailyGoal", parseInt(e.target.value) || 0)}
                    min="0"
                    max="480"
                  />
                </div>

                {Object.entries(settings.learning).filter(([key]) => !["difficulty", "preferredStudyTime", "dailyGoal"].includes(key)).map(([key, value]) => (
                  <div key={key} className="flex items-center justify-between">
                    <div>
                      <label className="font-medium capitalize">
                        {key.replace(/([A-Z])/g, " $1").toLowerCase()}
                      ...
                      <p className="text-sm text-muted-foreground">
                        {key === "studyReminders" && "Receive reminders to study regularly"}
                        {key === "showProgress" && "Display your progress on leaderboards and profiles"}
                        {key === "adaptiveLearning" && "Adjust difficulty based on your performance"}
                      </p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={(e) => handleSettingChange("learning", key, e.target.checked)}
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                    </label>
