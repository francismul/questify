...
export function StudentDashboardSidebar() {
  ...
  const studentMenuItems = [
    { title: t("dashboard"), icon: LayoutDashboard, href: "/student/dashboard" },
    { title: t("myCourses"), icon: BookOpen, href: "/student/courses" },
    { title: t("reports"), icon: FileText, href: "/student/reports" },
    { title: t("achievements"), icon: Trophy, href: "/student/achievements" },
    { title: t("goals"), icon: Target, href: "/student/goals" },
    { title: t("messages"), icon: MessageSquare, href: "/student/messages" },
    { title: t("myProfile"), icon: User, href: "/student/profile" },
    { title: t("settings"), icon: Settings, href: "/student/settings" },
  ];
  ...
  const toggleCollapsed = () => {
    ...
    if (typeof window !== 'undefined') {
      localStorage.setItem('student-sidebar-collapsed', newCollapsed.toString());
    }
  };

  // Load collapsed state from localStorage after hydration
  useEffect(() => {
    const storedCollapsed = localStorage.getItem('student-sidebar-collapsed');
