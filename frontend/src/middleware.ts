...
export function middleware(req: NextRequest) {
  ...
  // User is authenticated if they have a valid refresh token and user data
  // Access token can be refreshed automatically when needed
  const isAuthenticated = !!(refreshToken && userData);
